...
if ($result === false) {
    error_log("Database query failed in header-user-profile.php: " . $conn->error);
} else {
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="../assets/images/<?php echo htmlspecialchars($current_settings['site_logo']); ?>?v=<?php echo $cache_bust; ?>">
